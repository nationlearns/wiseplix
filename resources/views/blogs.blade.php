                                            ...
                                            <div class="post-bx">
                                                ...
                                                <div class="post-info">
                                                    <div class="post-meta">
                                                        <ul>
                                                            ...
                                                            <li class="post-author">By
                                                                <a href="{{route('blos.details',$item->slug)}}" title="Posts by admin"
                                                                    rel="author">{{ $item->created_by }}</a>
                                                            </li>
                                                    ...
                                                    <div class="post-text">
                                                        <h4 class="post-title">
                                                            <a
                                                                href="{{route('blos.details',$item->slug)}}">{{ substr($item->title, 0, 35) }}....</a>
                                                        </h4>
                                                    </div>
                                      ...
                                      @foreach ($data as $item)
                                        <div class="widget-post clearfix">
                                            <div class="wt-post-media">
                                                <img src="{{ asset($item->blogs_image) }}"
                                                    alt="">
                                            </div>
