            ...
            <div class="container container-two nav-container">
                ...
                <div class="collapse navbar-collapse" id="bizcoxx_main_menu">
                    <ul class="navbar-nav">
                        ...
                        <li class="menu-item-has-children">
                            <a href="{{url('service-list')}}">Service List</a>
                        </li>
                        <li class="menu-item-has-children">
            ...
            <div class="row margin-top-20">
                ...
                <div class="col-lg-4 col-md-6 margin-top-30">
                    <div class="single-service no-margin wow fadeInUp" data-wow-delay=".2s">
                        <a href="service_details.html" class="service-thumb">
                            <img src="{{asset('frontend/assets/img/service/s1.jpg')}}" alt>
                ...
                <div class="col-lg-4 col-md-6 margin-top-30">
                    <div class="single-service no-margin wow fadeInDown" data-wow-delay=".2s">
                        <a href="service_details.html" class="service-thumb">
                            <img src="{{asset('frontend/assets/img/service/s2.jpg')}}" alt>
                            <div class="award-icons">
                                <i class="las la-award"></i>
                            </div>
                        </a>
                            ...
                            <ul class="author-tag">
                                <li class="tag-list">
                                    <a href="javascript:void(0)">
                                        <div class="authors">
                                            <div class="thumb">
                                                <img src="{{asset('frontend/assets/img/service/author2.jpg')}}" alt>
                                                <span class="notification-dot"></span>
                                            </div>
                ...
                <div class="col-lg-4 col-md-6 margin-top-30">
                    <div class="single-service no-margin wow fadeInUp" data-wow-delay=".2s">
                        <a href="service_details.html" class="service-thumb">
                            <img src="{{asset('frontend/assets/img/service/s3.jpg')}}" alt>
                            <div class="award-icons">
                                <i class="las la-award"></i>
                            </div>
                        </a>
                            ...
                            <ul class="author-tag">
                                <li class="tag-list">
                                    <a href="javascript:void(0)">
                                        <div class="authors">
                                            <div class="thumb">
                                                <img src="{{asset('frontend/assets/img/service/author3.jpg')}}" alt>
                                                <span class="notification-dot"></span>
                                            </div>
                ...
                <div class="col-lg-4 col-md-6 margin-top-30">
                    <div class="single-service no-margin wow fadeInDown" data-wow-delay=".2s">
                        <a href="service_details.html" class="service-thumb">
                            <img src="{{asset('frontend/assets/img/service/s4.jpg')}}" alt>
                            <div class="award-icons">
                                <i class="las la-award"></i>
                            </div>
                        </a>
                            ...
                            <ul class="author-tag">
                                <li class="tag-list">
                                    <a href="javascript:void(0)">
                                        <div class="authors">
                                            <div class="thumb">
                                                <img src="{{asset('frontend/assets/img/service/author4.jpg')}}" alt>
                                                <span class="notification-dot"></span>
                                            </div>
                ...
                <div class="col-lg-4 col-md-6 margin-top-30">
                    <div class="single-service no-margin wow fadeInUp" data-wow-delay=".2s">
                        <a href="service_details.html" class="service-thumb">
                            <img src="{{asset('frontend/assets/img/service/s5.jpg')}}" alt>
                            <div class="award-icons">
                                <i class="las la-award"></i>
                            </div>
                        </a>
                            ...
                            <ul class="author-tag">
                                <li class="tag-list">
                                    <a href="javascript:void(0)">
                                        <div class="authors">
                                            <div class="thumb">
                                                <img src="{{asset('frontend/assets/img/service/author5.jpg')}}" alt>
                                                <span class="notification-dot"></span>
                                            </div>
                ...
                <div class="col-lg-4 col-md-6 margin-top-30">
                    <div class="single-service no-margin wow fadeInDown" data-wow-delay=".2s">
                        <a href="service_details.html" class="service-thumb">
                            <img src="{{asset('frontend/assets/img/service/s6.jpg')}}" alt>
                            <div class="award-icons">
                                <i class="las la-award"></i>
                            </div>
                        </a>
                            ...
                            <ul class="author-tag">
                                <li class="tag-list">
                                    <a href="javascript:void(0)">
                                        <div class="authors">
                                            <div class="thumb">
                                                <img src="{{asset('frontend/assets/img/service/author6.jpg')}}" alt>
                                                <span class="notification-dot"></span>
                                            </div>
                ...
                <div class="col-lg-4 col-md-6 margin-top-30">
                    <div class="single-service no-margin wow fadeInUp" data-wow-delay=".2s">
                        <a href="service_details.html" class="service-thumb">
                            <img src="{{asset('frontend/assets/img/service/s7.jpg')}}" alt>
                            <div class="award-icons">
                                <i class="las la-award"></i>
                            </div>
                        </a>
                            ...
                            <ul class="author-tag">
                                <li class="tag-list">
                                    <a href="javascript:void(0)">
                                        <div class="authors">
                                            <div class="thumb">
                                                <img src="{{asset('frontend/assets/img/service/author7.jpg')}}" alt>
                                                <span class="notification-dot"></span>
                                            </div>
                ...
                <div class="col-lg-4 col-md-6 margin-top-30">
                    <div class="single-service no-margin wow fadeInDown" data-wow-delay=".2s">
                        <a href="service_details.html" class="service-thumb">
                            <img src="{{asset('frontend/assets/img/service/s8.jpg')}}" alt>
                            <div class="award-icons">
                                <i class="las la-award"></i>
                            </div>
                        </a>
                            ...
                            <ul class="author-tag">
                                <li class="tag-list">
                                    <a href="javascript:void(0)">
                                        <div class="authors">
                                            <div class="thumb">
                                                <img src="{{asset('frontend/assets/img/service/author8.jpg')}}" alt>
                                                <span class="notification-dot"></span>
                                            </div>
                ...
                <div class="col-lg-4 col-md-6 margin-top-30">
                    <div class="single-service no-margin wow fadeInUp" data-wow-delay=".2s">
                        <a href="service_details.html" class="service-thumb">
                            <img src="{{asset('frontend/assets/img/service/s9.jpg')}}" alt>
                            <div class="award-icons">
                                <i class="las la-award"></i>
                            </div>
                        </a>
                            ...
                            <ul class="author-tag">
                                <li class="tag-list">
                                    <a href="javascript:void(0)">
                                        <div class="authors">
                                            <div class="thumb">
                                                <img src="{{asset('frontend/assets/img/service/author9.jpg')}}" alt>
                                                <span class="notification-dot"></span>
                                            </div>
                ...
                <div class="col-lg-4 col-md-6 margin-top-30">
                    <div class="single-service no-margin wow fadeInDown" data-wow-delay=".2s">
                        <a href="service_details.html" class="service-thumb">
                            <img src="{{asset('frontend/assets/img/service/s10.jpg')}}" alt>
                            <div class="award-icons">
                                <i class="las la-award"></i>
                            </div>
                        </a>
                            ...
                            <ul class="author-tag">
                                <li class="tag-list">
                                    <a href="javascript:void(0)">
                                        <div class="authors">
                                            <div class="thumb">
                                                <img src="{{asset('frontend/assets/img/service/author10.jpg')}}" alt>
                                                <span class="notification-dot"></span>
                                            </div>
                ...
                <div class="col-lg-4 col-md-6 margin-top-30">
                    <div class="single-service no-margin wow fadeInUp" data-wow-delay=".2s">
                        <a href="service_details.html" class="service-thumb">
                            <img src="{{asset('frontend/assets/img/service/s11.jpg')}}" alt>
                            <div class="award-icons">
                                <i class="las la-award"></i>
                            </div>
                        </a>
                            ...
                            <ul class="author-tag">
                                <li class="tag-list">
                                    <a href="javascript:void(0)">
                                        <div class="authors">
                                            <div class="thumb">
                                                <img src="{{asset('frontend/assets/img/service/author11.jpg')}}" alt>
                                                <span class="notification-dot"></span>
                                            </div>
                ...
                <div class="col-lg-4 col-md-6 margin-top-30">
                    <div class="single-service no-margin wow fadeInDown" data-wow-delay=".2s">
                        <a href="service_details.html" class="service-thumb">
                            <img src="{{asset('frontend/assets/img/service/s12.jpg')}}" alt>
                            <div class="award-icons">
                                <i class="las la-award"></i>
                            </div>
                        </a>
                            ...
                            <ul class="author-tag">
                                <li class="tag-list">
                                    <a href="javascript:void(0)">
                                        <div class="authors">
                                            <div class="thumb">
                                                <img src="{{asset('frontend/assets/img/service/author12.jpg')}}" alt>
                                                <span class="notification-dot"></span>
                                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="footer-widget widget ">
                            <div class="about_us_widget">
                                <a href="index.html" class="footer-logo"> <img src="{{asset('frontend/assets/img/logo-footer.png')}}"
                                        alt="footer logo"></a>
                            </div>
                            ...
                            <div class="footer-inner">
                                <ul class="footer-link-address">
                                    ...
                                    <li class="list"> <span class="address"> <a
                                                href="https://bytesed.com/cdn-cgi/l/email-protection#c5ada0a9b585a8a4aca9eba6aaa8">
                                                <i class="las la-envelope"></i> <span class="__cf_email__"
                                                    data-cfemail="d9b1bcb5a999b4b8b0b5f7bab6b4">[email&#160;protected]</span></a>
                                        </span></li>
                                </ul>
                        ...
                        <div class="footer-widget widget">
                            ...
                            <div class="footer-inner">
                                <div class="footer-recent-single">
                                    <div class="footer-recent-flex">
                                        <a href="javascript:void(0)" class="recents-thumbs">
                                            <img src="{{asset('frontend/assets/img/footer/n1.jpg')}}" alt>
                                        </a>
                                ...
                                <div class="footer-recent-single">
                                    <div class="footer-recent-flex">
                                        <a href="javascript:void(0)" class="recents-thumbs">
                                            <img src="{{asset('frontend/assets/img/footer/n2.jpg')}}" alt>
                                        </a>
                                        <div class="footer-recent-text">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="copyright-payment">
                            <ul class="payment-list">
                                <li class="list">
                                    <a href="javascript:void(0)"> <img src="{{asset('frontend/assets/img/footer/c1.png')}}" alt> </a>
                                </li>
                                <li class="list">
                                    <a href="javascript:void(0)"> <img src="{{asset('frontend/assets/img/footer/c2.png')}}" alt> </a>
                                </li>
                                <li class="list">
                                    <a href="javascript:void(0)"> <img src="{{asset('frontend/assets/img/footer/c3.png')}}" alt> </a>
                                </li>
                                <li class="list">
                                    <a href="javascript:void(0)"> <img src="{{asset('frontend/assets/img/footer/c4.png')}}" alt> </a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<!-- Mirrored from bytesed.com/tf/qixer/qixer_html/service_list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Nov 2023 12:09:39 GMT -->
