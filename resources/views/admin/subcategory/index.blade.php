                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                             ...
                             <a href="#" data-bs-toggle="modal" data-bs-target="#addCategory" class="btn btn-primary my-3">Add SubCategory</a>
                                ...
                                <tbody>
                                    @foreach ($data as $key => $item)
                                        <tr>
                                            ...
                                            <td>{{$item->status}}</td>
                                            <td>
                                                <a href="{{route('admin.subcategory.edit', $item->id)}}" class="btn btn-sm btn-warning">Edit</a>
                                                ...
                                                <script>
                                                    ...
                                                    document.querySelectorAll('.delete-btn').forEach(button => {
                                                        button.addEventListener('click', function(event) {
                                                            ...
                                                            form.action = `/admin/all/subcategory/${objectId}/delete`; // Update the form action with object ID
                ...
                <div class="modal-body">
                    <form action="{{route('admin.subcategory.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="category_id" id="" class="form-control form-select" required>
