            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit Faq's</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.update.faqs') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="question"
                                                placeholder="Enter Faq's Question"  value="{{$id->question}}"/>
                                        </div>
                                    </div>
                                </div>
                                <label>Faq's Answer</label>
                                <textarea id="elm1" name="answers">{{$id->answers}}</textarea>

                                <input type="submit" value="Update Faqs" class="btn btn-dark mt-4">
                            </form>
