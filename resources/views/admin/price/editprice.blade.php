            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit Price</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update.price') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="points"
                                        placeholder="Enter Blog Place" value="{{$id->points}}">
                                </div>

                                <input type="submit" value="Update Price" class="btn btn-dark mt-4">
                            </form>
