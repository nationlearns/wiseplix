        ...
        <div class="container-fluid p-0">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="text-muted text-center font-size-18"><b>Partner Sign In</b></h4>
                        ...
                        <form class="form-horizontal mt-3" action="{{ route('login') }}" method="post">
                            ...
                            <div class="form-group mb-0 row mt-2">
                                ...
                                <div class="col-sm-5 mt-3">
                                    <a href="{{route('partner.register')}}" class="text-muted"><i class="mdi mdi-account-circle"></i> Create an account</a>
                                </div>
                            </div>
                        </form>
                    </div>
