...
<body>
                    ...
                    <div class="container clearfix">
                        ...
                        <div class="logo-header">
                            <div class="logo-header-inner logo-header-one">
                                <a href="{{ url('/') }}">
                                    <img src="{{ asset('images/logo/wiseplix-logo.png') }}" alt="" width="120"
                                        class="site-logo-has">
                                    <img src="{{ asset('images/logo/wiseplix-logo.png') }}" alt="" width="120"
                                ...
                                <div class="item">
                                    <div class="aon-cat-item">
                                        <div class="aon-cat-pic media-bg-animate shine-hover">
                                            <a class="shine-box" href="{{ route('category.view', $item->slug) }}"><img
                                    ...
                                    <form class="aon-login-form" action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="aon-inputicon-box">
                                                        <input class="form-control sf-form-control" name="mobille"
    ...
    <div class="modal fade" id="questionModal" tabindex="-1" role="dialog" aria-labelledby="questionModalLabel"
        aria-hidden="true"
        style="margin-top:71px; overflow:hidden; position: fixed; font-family: system-ui; background-color: rgb(155 150 150 / 50%); "
        data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header"
                    style="padding:1rem !important; border-bottom: 0 none; background-image: url(https://nationlearns-bucket.s3.ap-south-1.amazonaws.com/images/newconnect.jpeg);">
