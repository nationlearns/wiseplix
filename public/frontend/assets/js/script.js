                ...
                success: function (data) {
                    if (data.length > 0) {
                        ...
                        $.each(data.slice(0, 10), function (index, item) {
                            var listItem = $('<li id="search-list">').text(
                                item.pincode +
                                    ", " +
                                    item.name +
                                    ", " +
                        ...
                        addressSuggestions.append(
                            '<li id="search-list">No Pincode</li>'
                        );
                    }
                },
            });
                ...
                success: function (data) {
                    ...
                    if (data.length > 0) {
                        ...
                        categorySuggestions.append(
                            '<li id="search-list">Not Available</li>'
                        );
                    }
                },
            });
...
$("#openModalBtn").click(function () {
    ...
    if (location === "") {
        alert("Please select Location from the dropdown");
    } else {
            ...
            if (res) {
                ...
                $.ajax({
                    ...
                    success: function (categoryRes) {
                        ...
                        document.getElementById("okeyButton").onclick =
                            function () {
                                window.location.href =
